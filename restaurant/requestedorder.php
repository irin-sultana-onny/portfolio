...
<body background="pic/70276-vintage-background.png">
 <div id="header">
      ...
      <ul>
		 ...
		 <li class='active'><a href='requestedorder.php'>Show Requested Order</a></li>
		  <li><a href='requestfromemployee.php'>Complete Order Request</a></li>
      </ul>
    </div>
<?php
$query=mysqli_query($con,"SELECT * FROM ordertableofcustomer") or die(mysql_error());
if(mysqli_num_rows($query)>0):
?>
<tr>
         <div id="body">
            <a>Requested Order List</a>
         </div>
      </tr>
      <form method="post">
<center>
...
<center>
  ...
  <tr>
    ...
    <td align="center"><?php echo $row->tableno;?></td>
